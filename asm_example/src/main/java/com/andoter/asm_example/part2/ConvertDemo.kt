...
fun main() {
    ...
    val classVisitor = ChangeVersionVisitor(Opcodes.ASM9, classWriter)
    ...
    val classVisitor2 = ChangeVersionVisitor(Opcodes.ASM9, classWriter2)
    classReader2.accept(classVisitor2, ClassReader.SKIP_CODE)

    println("===== 处理后的信息2  ======")
    val printVisitor2 = ClassPrintVisitor(Opcodes.ASM9)
