...
object TraceAnnotationAdapter : Opcodes {
    fun dump(): ByteArray {
        ...
        val printer = object : Textifier(Opcodes.ASM9) {
        ...
        classWriter.visit(
            Opcodes.ASM9, Opcodes.ACC_PUBLIC + Opcodes.ACC_ANNOTATION + Opcodes.ACC_ABSTRACT + Opcodes.ACC_INTERFACE,
        ...
        traceAnnotationVisitor = TraceAnnotationVisitor(av, printer)
        traceAnnotationVisitor.visitEnum(
