...
class Bean {
    ...
    fun getF(obj: Any?): Int {
        obj.toString()
        GenerateMethod.test(obj)
        return this.f
    }
...
fun main() {
    ...
    val methodVisitor = traceClassWriter.visitMethod(
        Opcodes.ACC_PUBLIC + Opcodes.ACC_FINAL, "getF",
        "()I", null, null
    )
