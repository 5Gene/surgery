...
class MyTryCatchMethodVisitor(
    ...
    override fun visitMaxs(maxStack: Int, maxLocals: Int) {
        ...
        super.visitMaxs(maxStack + 2 + consume.first, maxLocals + 1 + consume.second) // +2 for stack size (aload and invokevirtual), +1 for exception local var
        //maxLocals：
        // - 原始方法的本地变量数。
        // - 加上一个新的本地变量用于存储异常对象。
